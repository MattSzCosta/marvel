...
router.put(
  '/user/me',
  security,
  (req, res, next) => validator.validate(userValidation.userCreateValidator, req.body, res, next),
...
router.post(
  '/login',
  (req, res, next) => validator.validate(authValidation.login, req.body, res, next),
...
router.post(
  '/user/like',
  security,
  (req, res, next) => validator.validate(userValidation.userLikeValidator, req.body, res, next),
...
// Char
router.get('/chars', security, marvelController.getAllChar);

router.get('/char', security, marvelController.getCharById);

// Comics
router.get('/comics', security, marvelController.getAllComics);
